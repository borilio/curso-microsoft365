...
Es posible que, cuando leas esto, solo exista una única versión de Word por suscripción o que Microsoft haya cambiado nuevamente la nomenclatura.
...
![Pantalla inicial de Word](img/01 - word/word_inicial.png){.rounded-4}

Si hacemos clic en la opción **Documento en blanco**, aparece una pantalla como ésta.

![Pantalla Word en blanco](img/01 - word/ventana-word.png){.rounded-4}

En la sección **Entorno de Word** veremos todos sus componentes; ahora nos vamos a fijar sólo en algunas cosas.
...
![Intro](img/01 - word/intro.gif)

🟦**Punteros**. Una pequeña barra vertical parpadeante![descrip](img/01 - word/i_0_7a.gif){.img-inline} es la que marca tu posición en el texto. Se llama **punto de inserción** o **cursor**, porque allí donde esté situada es donde se introducirá el texto que teclees. Observarás que va avanzando según vas escribiendo.

No confundas el **cursor** con el **puntero del ratón**.

- El puntero tiene esta forma![descrip](img/01 - word/i_0_7.gif){.img-inline} cuando está dentro del área de texto, y esta otra ![descrip](img/01 - word/i_0_8a.gif){.img-inline} cuando está encima de los menús, también puede tomar otras formas que iremos viendo más adelante.
...
![Intro](img/01 - word/retroceso.gif){.rounded-2}
...
![Flechas teclado](img/01 - word/flechas_teclado.gif){.rounded-2}
...
Haz clic en el icono **Guardar** ![Guardar](img/01 - word/boton-guardar.png){.img-inline} de la zona superior izquierda o pulsa las teclas <kbd>CTRL + G</kbd>, como es la primera vez que guardamos el documento, aparecerá una ventana similar a esta.

![Guardar en Word la primera vez](img/01 - word/guardar_primera_vez.png){.rounded-4}
...
![descrip](img/01 - word/guardar_primera_vez_mas.png){.rounded-4}

Como vemos, las ubicaciones que empiezan por la letra `C:` ( o `D:`) son carpetas de nuestro ordenador. Podemos elegir una y luego pulsar el botón ![Boton Guardar](img/01 - word/boton_guardar.png){.img-inline}, y la otra forma que decíamos es pulsar en **Más ubicaciones ->** con lo que abrirá la pantalla **Guardar como** que se muestra en la siguiente imagen.

![Guardar como](img/01 - word/guardar_como.png){.rounded-4}
...
![descrip](img/01 - word/este_pc.png){.rounded-4}

![Examinar](img/01 - word/examinar.png){.rounded-4}
...
![descrip](img/01 - word/ventana_word_explicada.png){.rounded-4}
...
1. La **barra de herramientas de acceso rápido** ![La barra de herramientas de acceso rápido en Word](img/01 - word/barra_acceso_rapido.png){.img-inline} contiene, normalmente, las opciones que más frecuentemente se utilizan. Los botones son los siguientes: **Autoguardado**, para activar el guardado automático, **Guardar**, **Deshacer** (para deshacer la última acción realizada) **Rehacer** (para recuperar la acción que hemos deshecho) y **Personalizar**.  
<br>Cuando estamos en un documento guardado en OneDrive esta barra cambia ligeramente, ![descrip](img/01 - word/barra_acceso_rapido_365.png){.img-inline} **Autoguardado** esta activado por defecto y el botón **Guardar** es diferente ya que implica **sincronizar** los cambios con otros usuarios que estén compartiendo el documento. Todo esto lo veremos más adelante.
2. La **barra de título**, ![Barra del título en Word](img/01 - word/barra_titulo.png){.img-inline} como ya hemos comentado, contiene el nombre del documento abierto que se está visualizando, además el pequeño triángulo de la derecha abre la ventana del **Historial de versiones** que veremos en la unidad 4. Cuando el documento no está guardado en OneDrive, lo indica expresamente "Guardado en este PC".
3. **Buscar**, ![caja búsqueda](img/01 - word/caja_buscar.png){.img-inline} esta caja de búsqueda permite realizar búsquedas de texto en el propio documento y también buscar un comando de Word, por último permite buscar en Internet utilizando el buscador Bing de Microsoft. Lo veremos todo en detalle en el último punto de esta unidad.
4.  **Usuario**, ![Usuario de Word](img/01 - word/zona_usuario.png){.img-inline} aquí se muestra el nombre y el icono del usuario con el que estamos accediendo a Word. Si pulsamos se abrirá el desplegable que ves a continuación.
![Desplegable usuario de Word ](img/01 - word/desplegable_usuario.png){.rounded-4}  
...
5. ![Opciones de presentación de la cinta de Office](img/01 - word/opciones_presentacion_cinta.png){.img-inline} **Opciones de presentación de la cinta de Office**. Si haces **doble clic** sobre cualquiera de las pestañas, la barra se **ocultará**, para así disponer de más espacio de trabajo. Los comandos volverán a mostrarse en el momento en el que vuelvas a hacer **clic** en cualquier pestaña. Puedes cambiar es comportamiento por defecto haciendo clic en este botón ![Opciones de presentación de la cinta de Office](img/01 - word/opciones_presentacion_cinta.png){.img-inline}, se abrirá la ventana que se muestra a continuación, con tres opciones. La opción por defecto es la tercera, la primera opción mantiene oculta la cinta hasta que haces clic en la parte superior de la pantalla, la segunda opción sólo muestra las pestañas, pero no los comandos, al hacer clic en una pestaña mostrará los comandos.

![Desplegable de Opciones de presentación de la cinta de Office](img/01 - word/desplegable_opciones_presentacion_cinta.png){.rounded-2}

6. Los **botones** ![minimizar y maximizar la ventana de Word ](img/01 - word/minimizar_maximizar_cerrar.png){.img-inline} para cambiar **minimizar** y **maximizar** la ventana de Word y para **cerrar** Word.
...
![La barra de estado](img/01 - word/barra_estado_paginas.png){.rounded-2}  
...
9. Las **vistas del documento** ![Las vistas del documento  en Word](img/01 - word/vistas_documento.png){.img-inline} definen la forma en que se visualizará la hoja del documento. Por defecto se suele mostrar en **Vista de impresión**. Esto significa que veremos el formato de la hoja tal cual se imprimirá. Otros modos son para **leer**, para **diseño web** y el modo "**concentración**" que elimina todos las barras y pone fondo negro.
10. **Zoom** ![barra zoom en word](img/01 - word/barra_zoom.gif){.img-inline} se puede deslizar el marcador hacia los botones **-** y **+** para **alejar** o **acercar** el punto de vista, para apreciar en mayor detalle o ver una vista general del resultado. También podemos pulsar directamente sobre el valor porcentual para abrir una ventana donde ajustar el zoom deseado con varias opciones que se muestran en una vista previa, como muestra esta imagen.

![Cambiar zoom en word](img/01 - word/cambiar_zoom.gif){.rounded-2}
...
![image-20251102213536094](img/01 - word/image-20251102213536094.png){.rounded-2}  
...
![La cinta de opciones de Word](img/01 - word/cinta_opciones.png){.rounded-2}
...
> [!TIP]
>
> 🤯 **No intentes memorizar la ubicación de las opciones**. Las más comunes terminarás por aprenderlas, y las demás simplemente las buscas cuando te hagan falta. Ten en cuenta que estas opciones suelen cambiar muy a menudo entre distintas versiones y no merece la pena memorizar nada. 
>
> 🔎**Aprende a buscar eficientemente y nunca tendrás que memorizar.**
...
![Accesibilidad en Word](img/01 - word/accesibilidad.png){.rounded-4}
...
![descrip](img/01 - word/accesibilidad_negrita.png){.rounded-4}
...
Resumiendo, para poner en negrita, seleccionamos la palabra, pulsamos la tecla <kbd>ALT</kbd>, y luego la tecla <kbd>1</kbd>,
...
![La pestaña Archivo en Word](img/01 - word/pantalla_archivo.png){.rounded-4}
...
![Compartir en  word](img/01 - word/ventana_compartir.png){.rounded-4}

Otra particularidad de la ventana **Archivo** y de sus ventanas hijas, es la presencia del botón ![botón atrás](img/01 - word/boton-atras.gif){.img-inline} para volver atrás.
...
7. Localiza la acción **Deshacer** ![image-20240423121140601](img/01 - word/image-20240423121140601.png){.img-inline}(esquina superior izquierda, junto al nombre). Pulsa el botón. Observarás que el nombre vuelve a su posición inicial, deshaciendo la acción de centrado que acabamos de realizar.
...
> [!TIP]
>
> <img src="img/01 - word/image-20240423123420923.png" alt="image-20240423123420923" height="26rem" class="img-inline" /> Un documento bien estructurado siempre es más sencillo de manejar y es más accesible.
...
![Inicio > Estilos](img/01 - word/inicio-estilos.gif){.rounded-3}
...
![image-20240423125029858](img/01 - word/image-20240423125029858.png){.rounded-4}
...
Para ocultar de nuevo estas marcas debemos pulsar de nuevo el botón ![Marca párrafo](https://www.aulaclic.es/word-365/graficos/marca-parrafo.gif){.img-inline}.

## Dictar

También podemos introducir texto dictándolo directamente, obviamente debemos disponer de un micrófono conectado.

Desde el menú **Inicio** podemos pulsar en el icono **Dictar**![descrip](img/01 - word/icono_dictar.png){.img-inline}y cambiará a esta forma ![descrip](img/01 - word/icono_dictando.png){.img-inline} para indicar que Word está escuchando lo que digamos, de forma casi inmediata, veremos como va apareciendo el texto en el documento. Para dejar de dictar basta pulsar de nuevo en el icono ![descrip](img/01 - word/icono_dictando.png){.img-inline}.
...
![Dictar en Word](img/01 - word/dictar.png){.rounded-4}
...
![descrip](img/01 - word/puntuacion_dictar.png){.rounded-4}
...
Recordar que el elemento que define la posición dentro de un documento Word es el **cursor**![descrip](img/01 - word/i_0_7a-1713870772340-44.gif){.img-inline} que es una línea vertical parpadeante y nos indica dónde se va a escribir la próxima letra que tecleemos.
...
![Panel de Navegación](img/01 - word/panel_navegacion_titulos.png){.rounded-4}

Este "índice de contenidos" aparecerá siempre que se haya realizado un esquema correcto usando los **Títulos** correctos como se indicó en el apartado **Estructura de texto**.
...
![image-20240529105846387](img/01 - word/image-20240529105846387.png){.rounded-4}
...
<img src="img/01 - word/carta_presentacion.gif" alt="Carta de presentación del currículum" style="zoom: 150%;" class="rounded-4" />
...
![Selección de un texto](img/01 - word/seleccion.png){.rounded-4}
...
> - Colocar el cursor justo al inicio de la línea, veremos que el cursor cambia de forma y se convierte en una flecha ![descrip](img/01 - word/i_0_8d.gif){.img-inline}, hacer **clic** y la línea completa quedará seleccionada; si hacemos **doble** **clic**, el párrafo completo quedará seleccionado.
...
> [!TIP]
>
>  Para borrar una palabra errónea basta con hacer doble clic sobre ella para seleccionarla y al empezar a escribir, automáticamente se borrará la palabra seleccionada y podremos seguir escribiendo en su lugar la palabra correcta.
...
Para deshacer la última acción realizada, pulsar el icono **Deshacer**, ![deshacer](img/01 - word/boton-deshacer.gif){.img-inline} de la barra de acceso rápido.
...
Utilizando el icono **Rehacer** ![descrip](img/01 - word/boton-rehacer1.gif){.img-inline}, de la misma forma, podemos rehacer las acciones que acabamos de deshacer. Por ejemplo, si ponemos en cursiva un párrafo y deshacemos la acción porque pensamos que no queda bien en cursiva pero al cabo de un momento pensamos que sí queda mejor en cursiva podemos rehacer la acción y volver a dejarlo en cursiva.
...
![Errores subrayados](img/01 - word/error-gramatical-ortografico.png){.rounded-3}
...
![Error ortográfico en Word](img/01 - word/contextual-error-ortografico.png){.rounded-4}
...
1. Abre Word. Se iniciará un documento en blanco. Teclea el siguiente texto, incluidos los errores:
   ...
   > ![Texto con errores gramáticos y ortográficos](img/01 - word/image-20240424115512899.png){.rounded-4}
...
![descrip](img/01 - word/panel_editor.png){.rounded-4}
...
![descrip](img/01 - word/panel_lenguaje_formal2.png){.rounded-4}
...
![descrip](img/01 - word/panel_lenguaje_formal3.png){.rounded-4}

🟦 Una vez finaliza la revisión de todo el documento, se muestra un mensaje de aviso como el siguiente:

![Terminada la revisión del editor](img/01 - word/revision_terminada.png){.rounded-4}
...
![panel de sinónimos](img/01 - word/panel-sinonimos.png){.rounded-4}
...
![Referencia - menú contextual](img/01 - word/sinonimos-contextual.png){.rounded-4}
...
![Botón Temas](img/01 - word/boton-temas.png){.rounded-4}
...
![botón portada](img/01 - word/boton-portada.png){.rounded-4}
...
![Portadas integradas](img/01 - word/menu-portadas.png){.rounded-4}
...
![Portada - editar título](img/01 - word/image-20251102220710795.png){.rounded-4}
...
![Barra formato](img/01 - word/herramientas-fuente.gif){.rounded-2}

También aparecen las herramientas de formato automáticamente al seleccionar una palabra o frase.

![descrip](img/01 - word/menu-formato-automatico.png){.rounded-2}
...
![Fuente desplegado](img/01 - word/listado-fuentes-abierto.png){.rounded-2}
...
![Tipo fuente](img/01 - word/fuentes-y-tamanyo.gif){.rounded-2}
...
🟦 **Colores del texto:** Para dar algo de **color** al texto, utilizamos las herramientas ![Efectos de texto](img/01 - word/efectos-texto.png){.img-inline} que también se pueden aplicar a la vez. Están en la pestaña **Inicio** > grupo **Fuente** y desde el menú contextual.

- ![Efectos de texto](img/01 - word/fuente-color.png){.img-inline} **Color de fuente**: Es el color del texto. La línea que se dibuja bajo la letra **A** del icono es el color que hay seleccionado actualmente. También dispone de una paleta de colores que se muestra al pulsar su correspondiente flecha.

![menú Color de fuente](img/01 - word/fuente-color-desplegado.png)

- ![Efectos de texto](img/01 - word/fuente-resaltado.png){.img-inline} **Color de resaltado del texto**: Al pulsar sobre este botón el cursor cambiará y tomará la forma de un rotulador de resaltado. Colorea el fondo del texto del color indicado, del mismo modo que resaltaríamos sobre una hoja de papel con un rotulador. 

  Para cambiar el color, pulsa la flecha de la derecha y selecciona cualquiera de la paleta de colores disponibles.

  ![image-20251102221318169](img/01 - word/image-20251102221318169.png){.rounded-3}
...
- ![Efectos de texto](img/01 - word/fuente-efectos.gif){.img-inline} **Efectos de texto**: Al pulsar sobre la flecha de efectos se despliega un menú con 20 formatos prediseñados que incluyen sombreados, reflejos, letras con bordes de un color distinto al fondo, y demás efectos.

  ![menú Efectos](img/01 - word/fuente-efectos-desplegado.gif){.rounded-2}
...
![descrip](img/01 - word/insert_wordart.png){.rounded-2}
...
![Galería de WordArt](img/01 - word/wordart1.gif){.rounded-2}
...
![Modificar texto de WordArt](img/01 - word/wordart2.gif){.rounded-2}
...
![Barra formato](img/01 - word/herramientas-parrafo.gif){.rounded-2}

🟦 **Alineación**: Estos son los botones ![descrip](img/01 - word/boton-alineacion.gif){.img-inline} para fijar la alineación. Hay cuatro tipos de alineación:
...
> [!CAUTION]
>
> 🚧Se recomienda no cambiar la sangría hasta no tener un conocimiento más avanzado, ya que es bastante fácil "romper" el documento y muy complicado el volver a su estado original.



## Viñetas y listas numeradas

En el grupo **Párrafo** de la pestaña **Inicio** también encontramos herramientas para crear listas. ![Listas](img/01 - word/botones-listas.gif){.img-inline}
...
![Listas no numeradas](img/01 - word/image-20251102221710691.png){.rounded-2}

![Listas numeradas](img/01 - word/image-20251102221750987.png){.rounded-2}

![Listas anidadas](img/01 - word/image-20251102221808734.png){.rounded-2}
...
12. Escribe **Paraguas**, **Cargadores**, **GPS**, separados por la tecla <kbd>Intro</kbd>. Pulsa dos veces la tecla <kbd>Intro</kbd> para salir de las viñetas. 

    El resultado hasta el momento deberá ser el siguiente:

    <img src="img/01 - word/image-20251102222526109.png" alt="image-20251102222526109" style="zoom:33%;" />
...
15. Selecciona ahora una de las viñetas del subnivel para seleccionarlas todas y repite la operación, pero esta vez selecciona la viñeta en forma de cuadrado negro. El resultado será el siguiente:
    ...
    <img src="img/01 - word/image-20251102222931081.png" alt="image-20251102222931081" style="zoom:33%;" />
...
Para imprimir un documento podemos pulsar las teclas <kbd>Control+P</kbd> o bien ir a la pestaña **Archivo** y seleccionar **Imprimir**. En la pantalla verás las opciones de impresión, tal y como se muestra en la siguiente imagen.
 ...
 ![descrip](img/01 - word/archivo-imprimir.png){.rounded-4}
...
1. **Usar la cuadrícula que simula una tabla**. Cada cuadrado representa una celda y al pasar el ratón sobre ella se coloreará en naranja la selección que realicemos. Al hacer clic confirmamos que la selección se ha realizado y se inserta la tabla en el documento. En el ejemplo de la imagen estaríamos creando una tabla de 3x3.
    ...
    ![descrip](img/01 - word/tabla3x3.gif){.rounded-2}

 2. **Insertar tabla**: Se abre una ventana que permite **especificar el número** de filas y columnas para la tabla.

    ![Insertar tabla en Word](img/01 - word/insertar-tabla2.png){.rounded-2}
 ...
 3. **Dibujar tabla:** El cursor tomará forma de lápiz y simplemente iremos dibujando las líneas que la formarán. Esta opción es más lenta, pero puede resultar muy útil para crear **tablas irregulares** o para retocar tablas ya existentes.
    ...
    ![Tabla irregular](img/01 - word/tabla_irregular.gif){.rounded-2}
...
![grupo Dibujar Bordes](img/01 - word/estilo_borde_tabla.png){.rounded-2}
...
Si queremos modificar la estructura de la tabla iremos a la pestaña de **Disposición,** grupo **Dibujar**, y a continuación pulsar sobre **Dibujar tabla** ![Dibujar tabla](img/01 - word/herram-dibujar-tabla.gif){.img-inline}.

![tabla disposición](img/01 - word/tabla-presentacion.png){.rounded-2}
...
3. Rellena los datos de la tabla e intenta que se parezca lo más posible a la siguiente imagen.
  ![image-20240424135056574](img/01 - word/image-20240424135056574.png){.rounded-2}

  > [!tip]
  >
  > Fíjate en la alineación del texto dentro de las celdas, no solo en los colorines 😉
...
![descrip](img/01 - word/insertar_tabla2b.png){.rounded-2}
...
![Tabla combinada](img/01 - word/tabla-combinar.gif){.rounded-2}

Para conseguirlo, utilizamos las opciones de la pestaña **Disposición** > grupo **Combinar**.

![descrip](img/01 - word/herram-combinar.gif){.rounded-2}
...
![image-20240424141832276](img/01 - word/image-20240424141832276.png){.rounded-2}
...
- A la segunda copia, prueba a darle un color a cada asignatura (por ejemplo, <span style="background-color:#FF5353;color:#800000;padding:0.4rem">Matemáticas</span>, <span style="background-color:#58E7FA;color:#03606D;padding:0.4rem">Lengua</span>). Hay que darle color a la celda, no usar la opción de resaltado de texto.
  ...
  - ✅ <img src="img/01 - word/image-20240531090229184.png" alt="image-20240531090229184" style="zoom:75%;" class="img-inline" />
  - ❌ <img src="img/01 - word/image-20240531090407188.png" alt="image-20240531090407188" style="zoom:75%;" class="img-inline" />
...
![Ilustraciones](img/01 - word/herram-ilustraciones.png){.rounded-2}
...
![descrip](img/01 - word/insertar_imagenes.png){.rounded-2}
...
![imágenes en línea](img/01 - word/imagenes-en-linea.png){.rounded-4}
...
![descrip](img/01 - word/busqueda_imagen_bing.png){.rounded-4}
...
![descrip](img/01 - word/imagenes_de_archivo.png){.rounded-4}
...
![Insertar imágen](img/01 - word/insertar_imagen.png){.rounded-4}
...
>
> ![image-20240424151200328](img/01 - word/image-20240424151200328.png){.rounded-4}
...
![Pestaña formato](img/01 - word/pestanya-formato.png){.rounded-2}
...
![image-20240424151757167](img/01 - word/image-20240424151757167.png){.rounded-4}
...
![Sección Tamaño](img/01 - word/seccion_tamanyo.png){.rounded-2}
...
![Sección Ajustar](img/01 - word/seccion_ajustar.gif){.rounded-2}
...
>
> ![eliminar fondo](img/01 - word/eliminar_fondo.png){.rounded-2}
>
> <img src="img/01 - word/image-20240424152919554.png" alt="image-20240424152919554" style="zoom:67%;" class="rounded-2" />
...
![Sección Organizar](img/01 - word/seccion_organizar.png){.rounded-2}

🟦 **Posición**: ajusta la imagen respecto a la página.

![Posición](img/01 - word/opciones_posicion.gif){.rounded-2}

🟦 **Ajustar texto:** Ajusta la imagen respecto del texto que la rodea

![Ajuste](img/01 - word/opciones_ajuste.gif){.rounded-2}
...
![image-20240425112211120](img/01 - word/image-20240425112211120.png){.rounded-4}
...
3. Vamos a crear una imagen con **Inteligencia Artificial** ✨. Vamos a ir a la web https://copilot.microsoft.com. Pídele algo parecido a esto, pero con tus propias palabras: `¿Puedes generarme una imagen de una persona cualquiera aleatoria que no exista, como si fuera una imagen para un curriculum?`. Siente libre de añadirle los parámetros que quieras e intentarlo más veces si no te convencen .
   ...
   <img src="img/01 - word/image-20250707095218740.png" alt="Imagen de la web de Microsoft Copilot creando imágenes con IA" style="zoom:67%;" class="rounded-4" />
...
5. Intenta que la imagen quede a la derecha del documento y los textos se sigan viendo bien.
   ...
   ![Texto a la izquierda e imagen a la derecha](img/01 - word/ejercicio-foto-cv3.gif){.rounded-2}
...
> [!important] Hola mundo!
>
>  <img src="img/01 - word/1024px-Microsoft_365_Copilot_Icon.svg.png" alt="File:Microsoft_365_Copilot_Icon.svg - Wikiwand" style="height:1.3rem" class="img-inline" />Hola, soy [Copilot](https://copilot.microsoft.com/ ). La inteligencia artificial de Microsoft. Te he ayudado en este ejercicio, pero puedo hacer otras muchas cosas como por ejemplo:
>
...
![Ilustraciones](img/01 - word/herram-ilustraciones-1714039412234-85.png){.rounded-2}

Selecciona la que más te guste y haz clic sobre ella.

![descrip](img/01 - word/insert_autoformas.png){.rounded-2}
...
![Organigrama](img/01 - word/organigrama.png){.rounded-4}
...
![Diagrama de secuencia](img/01 - word/diagrama_secuencia.png){.rounded-4}

> [!tip]
>
> Para manejar bien la utilidad de SmartArt, se recomienda saber utilizar la opción de Listas y Viñetas. Te ayudará mucho a no perder tiempo.
...
![{.rounded-2}](img/01 - word/organigrama_menu.png){.rounded-2}
...
![Galería de diagramas](img/01 - word/diagramas.gif){.rounded-4}

 

Nos dibuja un organigrama básico de varios niveles similar al que puedes ver en la siguiente figura.

![Organigrama básico](img/01 - word/organigrama_base.png){.rounded-4}
...
![organigrama escribir texto](img/01 - word/organigrama_escribir.png){.rounded-2}

Al insertar un organigrama nos aparecen las pestañas **Diseño de SmartArt** y **Formato**.

![Menú Organigrama](img/01 - word/menu_organigrama.png){.rounded-2}



## 👨‍🏫 Ejercicio 9

Vamos a realizar un esquema que representa la pirámide trófica de la alimentación. Usaremos la siguiente imagen como base. 

> [!important]
>
> Ten en cuenta que el ejemplo no es un documento de Word, si no una imagen de internet a la cual vamos a rehacer en Word con las herramientas que tenemos.

![image-20251102225626267](img/01 - word/image-20251102225626267.png){.rounded-4}
...
3. Rellena el panel de texto del SmartArt con el contenido de la pirámide de la imagen. Algo así:
   ...
   ![image-20240425125009795](img/01 - word/image-20240425125009795.png){.rounded-4}
...
9. Y listo. Tendrías que tener una pirámide super bonita 🥰. Te dejamos otra imagen como ejemplo para guiarte.
   ...
   ![image-20240425131342050](img/01 - word/image-20240425131342050.png){.rounded-4}

   > [!tip]
   >
   > 👩‍🎨Tienes total libertad creativa. No intentes “copiar” el ejemplo, ¡¡¡dale tu propio estilo!!!
...
![image-20240425135126411](img/01 - word/image-20240425135126411.png){.rounded-4}
...
![Tabla con celdas combinadas](img/01 - word/image-20240425141658138.png){.rounded-4}
...
3. Copiaremos esa información y la pegaremos en un documento de Word. Tendrá el esquema siguiente:
   ...
   ![image-20240503094817983](img/01 - word/image-20240503094817983.png){.rounded-4}

## 👨‍🏫 Ejercicio 13

Intenta replicar los carteles siguientes de la forma más parecida posible.

![image-20240506203150496](img/01 - word/image-20240506203150496.png){.rounded-4}

![image-20240506203227419](img/01 - word/image-20240506203227419.png){.rounded-4}
